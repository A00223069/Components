...
namespace PublicProfiler.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.Author.Include(p => p.Blogs).ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AuthorId,GivenName,Surname,Email")] Author author)
        {
