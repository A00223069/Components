...
namespace PublicProfiler.Controllers
{
    public class BlogsController : Controller
    {
        ...
        public BlogsController(ProfilerContext context)
        {
            _context = context;
        }
        ...
        {
            var profilerContext = _context.Blog.Include(b => b.Author);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BlogId,BlogTitle,BlogUrl,BlogDescription,AuthorId")] Blog blog)
        {
            if (id != blog.BlogId)
            {
                return NotFound();
