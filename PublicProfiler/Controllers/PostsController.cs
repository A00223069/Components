...
namespace PublicProfiler.Controllers
{
    public class PostsController : Controller
    {
        ...
        public PostsController(ProfilerContext context)
        {
            _context = context;
        }
        ...
        {
            var profilerContext = _context.Post.Include(p => p.Blog);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,PostTitle,PostContent,BlogId")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
